...
export const TasksPage = () => {
  ...
  return (
    <div className="flex flex-col gap-8 select-text">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-zinc-100 font-display">Tus Tareas Repetitivas</h2>
          <p className="text-zinc-500 text-xs mt-0.5">Mide el tiempo real de tus actividades recurrentes</p>
        </div>
        ...
        {tasks.map((task: any) => (
          <Card key={task._id} hoverable className="flex flex-col justify-between gap-6 relative group">
            ...
            <div>
              ...
              <h3 className="text-sm font-bold text-zinc-200 mb-1">{task.name}</h3>
              {task.description && (
