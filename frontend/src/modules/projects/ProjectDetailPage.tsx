        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-1.5">
            ...
            <span className="text-xs font-mono font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-0.5 rounded-lg">
              Tarifa: {currencySymbol}{convert(project.hourlyRate || defaultRate, project.currency || 'USD', userCurrency).toFixed(2)} {userCurrency}/h
            </span>
            <span className="text-xs font-mono font-bold text-violet-400 bg-violet-500/10 border border-violet-500/20 px-2.5 py-0.5 rounded-lg">
              Valor Generado: {currencySymbol}{convert(((project.accumulatedDuration || 0) / 3600) * (project.hourlyRate || defaultRate), project.currency || 'USD', userCurrency).toFixed(2)} {userCurrency}
            </span>
          </div>
        </div>
